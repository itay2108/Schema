...
class AboutViewController: BetterUIViewController {
    ...
    @IBOutlet weak var aboutSuperView: UIView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view.
        aboutSuperView.cornerRadius = 5
